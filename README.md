...
未降車の園児がいる場合、または最後尾確認がない場合は、送迎を完了できません。
...
4. 到着後、園児が降車するたびにQRを読み取ります。
5. 乗車人数と降車人数が一致したことを確認します。
6. 職員が座席、足元、座席の下、荷物の陰を目視確認します。
7. 車両の最後尾に設置したQRを読み取ります。
8. 車内を30秒撮影し、AIが確認を補助します。
9. 運転担当者とは別の職員が、車内と記録を再確認します。
10. 第三者承認後、日時・GPS・担当者・確認記録を保存します。
11. 必要に応じて、保護者へ降車完了を通知します。
