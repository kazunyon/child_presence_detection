...
管理者には固定の公開PINを設けていません。管理者がログインできない場合は、後述の「管理者PINの安全な復旧」を実施します。

### 管理者ID 3の復元記録

- 2026年7月24日：管理者ID `3` を復元
- 新しい8桁のPINへ再設定済み
- 管理者ID `3` と新しいPINによるログインを確認済み
- 実際のPINは、認証情報保護のためREADMEおよびGitへ記録しない
...
> [!WARNING]
> トークン、Secret、PINをGit、README、画面キャプチャ、ブラウザの保存領域へ記録しないでください。
