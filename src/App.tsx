...
export default function App(){
 ...
 return <div className="app">
  ...
  {tab==='home' && <>
   ...
   <section className="mt-5 rounded-2xl bg-slate-800 p-4 text-white"><div className="flex gap-3"><Icon>🔔</Icon><div><b>未確認アラーム</b><p className="m-0 mt-1 text-sm text-slate-300">降車確認から15分経過すると、管理者へ自動通知します。</p></div></div></section>
  </>}
