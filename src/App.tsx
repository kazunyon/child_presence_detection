...
type TripListItem = TripStatus & { started_at:string; completed_at:string|null; direction:string }
...
function Records({operator,auth,onMessage}:{operator:Operator;auth:AuthBuilder;onMessage:(message:string)=>void}) {
