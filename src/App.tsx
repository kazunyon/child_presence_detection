...
export default function App() {
  ...
  const returnSafetyCheck = async () => {
    ...
    setLocationStatus('車内確認と送迎完了を記録しています…')
    ...
    try {
      ...
      await loadDashboard()
      setLocationStatus('')
      setMessage('車内確認と送迎完了を記録しました。次のバスを選んでください。')
    } catch (error) { setLocationStatus('車内確認または送迎完了を保存できませんでした'); setMessage(error instanceof Error ? error.message : '車内確認または送迎完了を保存できませんでした') }
  }
